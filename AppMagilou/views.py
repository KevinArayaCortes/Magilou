...
def eliminar_carrito(request):
    if request.method == "POST":
        ...
        try:
            ...
            # Actualizar el carrito
            carrito.cantidad_productos -= carro_producto.cantidad_producto
            carrito.precio_total -= carro_producto.id_producto.precio_producto * carro_producto.cantidad_producto
            carrito.save()
            ...
            return JsonResponse({"error": "Producto o carrito no encontrado"}, status=404)
